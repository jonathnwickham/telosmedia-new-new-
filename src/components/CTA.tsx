    ...
    <section id="cta" className="text-center py-28 px-6 relative">
      ...
      <div className="flex justify-center gap-3 relative flex-col sm:flex-row items-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-7 py-3 bg-transparent text-foreground border border-border rounded-md text-[15px] font-medium hover:bg-card transition-all"
        >
          Contact via Email
        </a>
      </div>
